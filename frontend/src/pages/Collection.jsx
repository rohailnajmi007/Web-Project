...
const Title = ({ text1, text2 }) => (
  ...
  >
    {text1} <span style={{ fontWeight: 400 }}>{text2}</span>{" "}
    <span
      style={{
    ...
    <div className={`collection-flex${!showSearch ? " no-search" : ""}`}>
      {isMobile ? (
        <>
          {/* Heading */}
          <div
            className="collection-header-row"
            style={{ justifyContent: "center" }}
          >
            <div
              className="collection-title-col"
              style={{
                width: "100%",
                textAlign: "center",
          ...
          {/* Filters (full width) */}
          <div
            className="collection-filter-col"
            style={{ width: "100%", marginLeft: 0, marginBottom: "1rem" }}
          >
            {showFilter && (
              <>
